...
t_value_bm <- summary_mmc$coefficients["Number_of_episodes", "t value"]
p_value_bm <- summary_mmc$coefficients["Number_of_episodes", "Pr(>|t|)"]
r_squared_bm <- summary_mmc$r.squared
